                    ...
                    <form action="{{ route('admin.role.index') }}" method="GET">
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                @endcan
                                <input type="text" name="q" class="form-control" placeholder="Cari Berdasarkan Nama Role">
                                <div class="input-group-prepend">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @foreach ($roles as $no => $role)
                                <tr>
                                    <td scope="row" style="text-align: center;">{{ ++$no + ($roles->currentPage()-1) * $roles->perPage() }}</td>
                                    <td>{{ $role->name }}</td>
                                    <td>
