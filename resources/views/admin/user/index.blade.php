                    ...
                    <form action="{{ route('admin.user.index') }}" method="GET">
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                @endcan
                                <input type="text" class="form-control" name="q" placeholder="Cari User Berdasarkan Nama User">
                                <div class="input-group-prepend">
                            ...
                            <tbody>
                                @foreach ($users as $no => $user)
                                    ...
                                    <td class="text-center">
                                        @can('users.edit')
                                            <a href="{{ route('admin.user.edit', $user->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                        @endcan
                                        @can('users.delete')
